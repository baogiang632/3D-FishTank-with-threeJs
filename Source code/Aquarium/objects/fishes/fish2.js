...
export class Fish {
  constructor() {
    ...
    mtlLoader.load('../../models/fish/fish2/13006_Blue_Tang_v1_l3.mtl', function (materials) {
        materials.preload();
        new OBJLoader().setMaterials(materials).load('../../models/fish/fish2/13006_Blue_Tang_v1_l3.obj', object => {
          object.rotation.set(
            fishRotation[0],
            fishRotation[1],
            fishRotation[2]
